...
```text
propagation-router
-> semantic-workflow-coordinator（R7-H2 typed task、确定性提交、pointer-last 与恢复）
...
| [semantic-workflow-coordinator](./semantic-workflow-coordinator/SKILL.md) | 按 R7 蓝图和 projection 生成唯一 typed task，并由 H2 submitter 提交 revision / lineage / pointer / event / projection |
