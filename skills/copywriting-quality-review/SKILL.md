...
primary_input: draft + static_visual_director_plan + visual_need_analysis + visual_plan + visual_text_plan + image_asset_set
...
```text
读：content_brief、draft、visual_need_analysis、visual_plan、visual_text_plan、image_asset_set、字段词典、产品边界、dbskill 相关资料按需读取。
