...
- content_goal：信任 + 垂类获客。先建立“车商经营不能只靠低价”的判断，再轻带公开互动整理工具。
- target_audience：二手车商、汽车销售团队、门店老板，尤其是被价格战挤压、但又想通过短视频和直播建立信任的人。
- core_point：车商卷不过厂家价格战，但可以卷自己的信任资产；信任不是口号，是持续回应客户真实问题。
- hotspot_fact：汽车行业反内卷、价格战转价值战仍在公开媒体和行业讨论中出现，本轮定位为行业趋势观点，不包装成即时热点。
- source：证券时报、中青汽车频道等公开报道；调研运行记录 R20260706-001。
...
- derivation_chain：反内卷 -> 价格战不可持续 -> 车商要建立信任 -> 信任来自真实问题回应 -> 公开互动整理能帮助复盘这些问题。
- weakest_jump：从行业大话题落到单个车商自媒体动作，容易讲大讲空。
...
- account_tone：车商经营视角，直接、接地气、少讲宏大口号，多讲门店能做的小动作。
...
- opening_direction：先把大话题压到车商现场：“价格战这件事，小车商改不了，但你至少能改一件事：别让客户问过的问题白白流走。”
- body_structure：1. 先承认价格战和反内卷是行业趋势，不装作今天刚爆；2. 拉回车商现实，单店很难改变厂家价格策略；3. 提出信任资产的定义：客户问过什么、担心什么、反复卡在哪里；4. 给出动作：把评论区和直播间公开互动整理成复盘表；5. 轻点工具，公开互动分析工具适合做公开问题整理和 AI 分类；6. 收到免费学习版申请，但先强调适用边界。
...
| 人群具体 | 通过 | 明确给二手车商、销售团队和门店老板。 |
| 核心观点清楚 | 通过 | “卷信任资产”能承接价格战趋势和账号母题。 |
| 事实可靠 | 通过 | 多来源行业讨论支撑，但只按行业趋势使用。 |
| 推导链成立 | 通过 | 已用“小车商改不了价格战，但能改回应客户问题”补桥。 |
