...
function Test-P0PlanContract {
  ...
  $isRevisionPlan = (Test-P0HasProperty $Plan 'plan_schema_id') -and [string]$Plan.plan_schema_id -in @('taoge://schemas/p0/session-execution-plan/v0.9','taoge://schemas/p0/session-execution-plan/v1.0','taoge://schemas/p0/session-execution-plan/v1.1','taoge://schemas/p0/session-execution-plan/v1.2','taoge://schemas/p0/session-execution-plan/v1.3','taoge://schemas/p0/session-execution-plan/v1.4')
  ...
  $expected = if ([string]$Plan.plan_schema_id -eq 'taoge://schemas/p0/session-execution-plan/v1.4') {
    [ordered]@{
      workflow_definition_version = 'r7-hotspot-semantic-workflow-v0.6'
      contract_bundle_version = 'p0-contract-bundle-v1.4'
      plan_schema_id = 'taoge://schemas/p0/session-execution-plan/v1.4'
      ...
      runtime_mode = 'single'
      blueprint_id = 'hotspot_to_delivery_single_v0.6'
      blueprint_version = '0.6'
    }
  } elseif ([string]$Plan.plan_schema_id -eq 'taoge://schemas/p0/session-execution-plan/v1.3') {
    [ordered]@{
      workflow_definition_version = 'r7-direct-semantic-workflow-v0.6'
      contract_bundle_version = 'p0-contract-bundle-v1.3'
      plan_schema_id = 'taoge://schemas/p0/session-execution-plan/v1.3'
      event_schema_id = 'taoge://schemas/p0/execution-event/v0.2'
      artifact_lineage_schema_id = 'taoge://schemas/p0/artifact-lineage/v0.2'
      render_input_schema_id = 'taoge://schemas/final-delivery/typed-components/v0.9'
      renderer_version = 'final-delivery-renderer-v0.9'
      template_version = 'final-delivery-template-v0.9'
      runtime_mode = 'single'
      blueprint_id = 'direct_delivery_single_v0.6'
      blueprint_version = '0.6'
    }
  } elseif ([string]$Plan.plan_schema_id -eq 'taoge://schemas/p0/session-execution-plan/v1.2') {
    [ordered]@{
      workflow_definition_version = 'r7-hotspot-semantic-workflow-v0.5'
      contract_bundle_version = 'p0-contract-bundle-v1.2'
      plan_schema_id = 'taoge://schemas/p0/session-execution-plan/v1.2'
      event_schema_id = 'taoge://schemas/p0/execution-event/v0.2'
      artifact_lineage_schema_id = 'taoge://schemas/p0/artifact-lineage/v0.2'
      render_input_schema_id = 'taoge://schemas/final-delivery/typed-components/v0.9'
      renderer_version = 'final-delivery-renderer-v0.9'
      template_version = 'final-delivery-template-v0.9'
      runtime_mode = 'single'
      blueprint_id = 'hotspot_to_delivery_single_v0.5'
      blueprint_version = '0.5'
    }
  } elseif ([string]$Plan.plan_schema_id -eq 'taoge://schemas/p0/session-execution-plan/v1.1') {
    [ordered]@{
      workflow_definition_version = 'r7-direct-semantic-workflow-v0.5'
      contract_bundle_version = 'p0-contract-bundle-v1.1'
      plan_schema_id = 'taoge://schemas/p0/session-execution-plan/v1.1'
      event_schema_id = 'taoge://schemas/p0/execution-event/v0.2'
      artifact_lineage_schema_id = 'taoge://schemas/p0/artifact-lineage/v0.2'
      render_input_schema_id = 'taoge://schemas/final-delivery/typed-components/v0.9'
      renderer_version = 'final-delivery-renderer-v0.9'
      template_version = 'final-delivery-template-v0.9'
      runtime_mode = 'single'
      blueprint_id = 'direct_delivery_single_v0.5'
      blueprint_version = '0.5'
    }
  } elseif ([string]$Plan.plan_schema_id -eq 'taoge://schemas/p0/session-execution-plan/v1.0') {
    [ordered]@{
  ...
  } elseif ([string]$Plan.plan_schema_id -eq 'taoge://schemas/p0/session-execution-plan/v0.8') {
    [ordered]@{
      workflow_definition_version = 'r7-hotspot-semantic-workflow-v0.2'
      contract_bundle_version = 'p0-contract-bundle-v0.8'
      plan_schema_id = 'taoge://schemas/p0/session-execution-plan/v0.8'
      event_schema_id = 'taoge://schemas/p0/execution-event/v0.2'
      artifact_lineage_schema_id = 'taoge://schemas/p0/artifact-lineage/v0.2'
      render_input_schema_id = 'taoge://schemas/final-delivery/typed-components/v0.7'
      renderer_version = 'final-delivery-renderer-v0.7'
      template_version = 'final-delivery-template-v0.7'
      runtime_mode = 'single'
      blueprint_id = 'hotspot_to_delivery_single_v0.2'
      blueprint_version = '0.2'
    }
  } elseif ([string]$Plan.plan_schema_id -eq 'taoge://schemas/p0/session-execution-plan/v0.7') {
    [ordered]@{
  ...
  } elseif ([string]$Plan.plan_schema_id -eq 'taoge://schemas/p0/session-execution-plan/v0.3') {
    [ordered]@{
      workflow_definition_version = 'p0-single-runtime-v0.2'
  ...
  if ($isHotspotPlan -or $isRevisionPlan) {
    if ([int]$Plan.plan_revision -lt 1) { $errors.Add('plan_revision_metadata_invalid') }
    if ($null -ne $Plan.supersedes_plan_id -and [string]::IsNullOrWhiteSpace([string]$Plan.supersedes_plan_id)) { $errors.Add('plan_revision_metadata_invalid') }
  }
  if($isRevisionPlan-and$Plan.test_profile-notin@('production','no_provider','reuse_only')){$errors.Add('plan_test_profile_invalid')}
  ...
  foreach ($step in @($Plan.steps)) {
    ...
    if ($isR7Plan) {
      ...
      $replanIdentity=if(($isHotspotPlan-or$isRevisionPlan)-and[int]$Plan.plan_revision-gt1){"$expectedIdentity-R$([int]$Plan.plan_revision)"}else{$null}
...
function Test-P0CompatibilityMatrixContract {
  ...
  if ([string]$Document.matrix_version -in @('0.3','0.4','0.5')) {
    foreach ($pair in @($requiredPairs[1..($requiredPairs.Count-2)])) {
      ...
      $migration = $seen[$pair]
      if (-not $migration.replay_readable -or $migration.resume_executable -or $migration.renderable -or -not $migration.migration_required) { $errors.Add("compatibility_migration_policy_invalid:$pair") }
    }
  }
  return [object[]]$errors.ToArray()
}
