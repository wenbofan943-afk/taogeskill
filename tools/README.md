...
| `invoke-r7-semantic-workflow.ps1` | standard / compatibility | legacy R7 稳定 CLI shim；经 compatibility loader 解析 `compatibility/legacy-r7/tools/` 中的版本钉住实现，执行 initialize / prepare / submit / reconcile | session `intermediate/r7/` | session evidence |
