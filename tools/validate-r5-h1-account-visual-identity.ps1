...
function Test-R5H1Identity([object]$Identity, [object]$Columns) {
  ...
  if ($Identity.schema_id -ne 'taoge://schemas/r5/account-visual-identity/v0.1') { $errors.Add('schema_id_invalid') }
  if ([string]$Identity.schema_version -ne '0.1') { $errors.Add('schema_version_invalid') }
  ...
  if (-not (Has-R5H1 $Columns 'schema_id') -or $Columns.schema_id -ne 'taoge://schemas/r5/column-visual-templates/v0.1') { $errors.Add('column_schema_id_invalid') }
