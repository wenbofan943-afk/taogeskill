...
try {
  ...
  $copyItems = @(
    ...
    "tools\invoke-workflow-runtime.ps1", "tools\P0ContractHelper.ps1", "tools\P0RuntimeV02.ps1", "tools\validate-p0-h1-contracts.ps1", "tools\validate-p0-h2-runtime.ps1"
  )
