...
try {
  ...
  $copyItems = @(
    ...
    "tools\validate-route-schema.ps1", "tools\validate-gates.ps1", "tools\validate-doc-governance.ps1", "tools\validate-cover-composition.ps1", "tools\validate-r3-visual-text.ps1", "tools\R3VisualBudget.ps1", "tools\validate-r3-visual-budget.ps1", "tools\R3VisualNeed.ps1", "tools\validate-r3-visual-need.ps1", "tools\validate-r5-h1-account-visual-identity.ps1", "tools\validate-release-gate.ps1", "tools\export-support-log.ps1",
