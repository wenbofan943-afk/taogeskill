...
try {
  ...
  $copyItems = @(
    ...
    "tools\R7SemanticRuntime.ps1", "tools\invoke-r7-semantic-workflow.ps1", "tools\validate-r7-h2-runtime.ps1", "tools\new-r7-semantic-submission.ps1", "tools\validate-r7-h3-producer-adapters.ps1"
  )
