...
try {
  ...
  $copyItems = @(
    ...
    "tools\invoke-workflow-runtime.ps1", "tools\P0ContractHelper.ps1", "tools\P0ContractV04.ps1", "tools\P0RuntimeV02.ps1", "tools\P0FinalDeliveryV03.ps1", "tools\P0FinalDeliveryV04.ps1", "tools\P0EvidenceRuntime.ps1", "tools\R3VisualPresentation.ps1", "tools\invoke-p0-evidence.ps1", "tools\validate-p0-h1-contracts.ps1", "tools\validate-p0-h2-runtime.ps1", "tools\validate-p0-h3-fixtures.ps1", "tools\validate-p0-h4-evidence.ps1", "tools\invoke-p0-h5-regression.ps1", "tools\validate-p0-h5-regression.ps1", "tools\validate-p0-h6-preflight.ps1", "tools\complete-p0-h6-regression.ps1", "tools\validate-p0-h6-regression.ps1", "tools\validate-p0-h6-reliability.ps1", "tools\prepare-p0-h7-delivery.ps1", "tools\complete-p0-h7-delivery.ps1", "tools\validate-p0-h7-delivery.ps1", "tools\validate-p0-h7-fixtures.ps1", "tools\validate-p0-h7-v04-delivery.ps1", "tools\validate-p0-h7-v04-fixtures.ps1", "tools\validate-r3-visual-presentation.ps1"
  )
  ...
  $requiredCurrentRuntimeClosure = @(
    'tools\P0ContractV04.ps1',
    'tools\P0FinalDeliveryV04.ps1',
    'tools\R3VisualPresentation.ps1',
    'tools\validate-p0-h7-v04-delivery.ps1',
    'tools\validate-p0-h7-v04-fixtures.ps1',
    'tools\validate-r3-visual-presentation.ps1'
  )
