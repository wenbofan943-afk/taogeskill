...
function New-R7CandidatePayload {
  ...
  $presentation=if($isHotspot-or$isV08){Read-YamlFile (Join-Path $ProjectRoot 'routes/r7-delivery-presentation-registry.yaml')}else{Read-WorkflowCompatibilityYamlAsset -ProjectRoot $ProjectRoot -AssetReference 'routes/r7-delivery-presentation-registry.v0.1.yaml' -CallerRuntimeGeneration 'legacy_r7'}
  $actions=if($isHotspot-or$isV08){Read-YamlFile (Join-Path $ProjectRoot 'routes/r7-action-registry.yaml')}else{Read-WorkflowCompatibilityYamlAsset -ProjectRoot $ProjectRoot -AssetReference 'routes/r7-action-registry.v0.1.yaml' -CallerRuntimeGeneration 'legacy_r7'}
  ...
  $actionRegistryRef=$(if($isHotspot-or$isV08){'routes/r7-action-registry.yaml'}else{'routes/r7-action-registry.v0.1.yaml'});$presentationRegistryRef=$(if($isHotspot-or$isV08){'routes/r7-delivery-presentation-registry.yaml'}else{'routes/r7-delivery-presentation-registry.v0.1.yaml'})
  $actionRegistryPath=$(if($isHotspot-or$isV08){Join-Path $ProjectRoot $actionRegistryRef}else{Resolve-WorkflowCompatibilityAsset -ProjectRoot $ProjectRoot -AssetReference $actionRegistryRef -CallerRuntimeGeneration 'legacy_r7'});$presentationRegistryPath=$(if($isHotspot-or$isV08){Join-Path $ProjectRoot $presentationRegistryRef}else{Resolve-WorkflowCompatibilityAsset -ProjectRoot $ProjectRoot -AssetReference $presentationRegistryRef -CallerRuntimeGeneration 'legacy_r7'})
