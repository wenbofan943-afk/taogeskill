...
function New-R7CandidatePayload {
  ...
  $presentation=Read-YamlFile (Join-Path $ProjectRoot $(if($isHotspot-or$isV08){'routes/r7-delivery-presentation-registry.yaml'}else{'routes/r7-delivery-presentation-registry.v0.1.yaml'}))
  $actions=Read-YamlFile (Join-Path $ProjectRoot $(if($isHotspot-or$isV08){'routes/r7-action-registry.yaml'}else{'routes/r7-action-registry.v0.1.yaml'}))
  ...
  $actionRegistryPath=$(if($isHotspot-or$isV08){'routes/r7-action-registry.yaml'}else{'routes/r7-action-registry.v0.1.yaml'});$presentationRegistryPath=$(if($isHotspot-or$isV08){'routes/r7-delivery-presentation-registry.yaml'}else{'routes/r7-delivery-presentation-registry.v0.1.yaml'})
