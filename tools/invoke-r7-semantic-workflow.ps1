param(
  ...
  [Parameter(Mandatory=$true)][ValidateSet('initialize','prepare_task','submit','reconcile','rebuild_projection')][string]$Mode,
  [string]$BlueprintId='direct_delivery_single_v0.1',
