param(
  ...
  [string]$CompatibilityMatrixPath = "templates/schema/p0/compatibility-matrix.v0.5.json",
...
try {
  ...
  $expectedSchemaIds = @(
    ...
    'taoge://schemas/p0/session-execution-plan/v0.5',
    ...
    'taoge://schemas/final-delivery/typed-components/v0.5'
  )
  $seenSchemaIds = @{}
