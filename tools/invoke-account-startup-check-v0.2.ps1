...
try {
  if ($SelfTest) {
    ...
    if ((New-R5H6AccountSessionSnapshot $request $result).schema_id -ne 'taoge://account/session-snapshot/v0.2') { throw 'self_test_snapshot_unexpected' }
