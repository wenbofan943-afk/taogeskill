...
workflow_usage_state：v0.1.0-alpha.10_release_candidate_validating
...
Git：已初始化独立本地工作母仓，当前分支 `main`；无凭据 HTTPS 远端为 `https://github.com/wenbofan943-afk/taogeskill.git`；上一已发布 tag 为 `v0.1.0-alpha.9`，当前候选为 `v0.1.0-alpha.10`；Git 入口由执行环境解析为 `<GIT_EXE>`
```
