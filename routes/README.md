...
| `r7-workflow-blueprints.yaml` | R7 v0.3 蓝图注册表；直供 v0.2 保持现行，热点 v0.2 的 H6A 前链已激活、H6B 交付节点待编译 |
...
| `r7-delivery-presentation-registry.yaml` | v0.2 Topic Gate 呈现及 H6B source context 预登记；热点最终页面仍待 H6B |
