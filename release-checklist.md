...
| P5CHK-005 | 发布状态诚实 | pass | release_state=tag_ready; publish_status=publish_ready_waiting_human；尚未 push / GitHub Release |  |
...
| P5CHK-013 | Release gate | ready_waiting_human | local candidate passes; release commit and local tag exist; remote / push / GitHub Release still need remote capability | configure remote, push branch and tag, then create GitHub Release |
...
push and GitHub Release: waiting for GitHub remote / auth capability
```
