...
| [schema/workflow-kernel/](./schema/workflow-kernel/) | M2 direct shadow request、stage result envelope 与 normalized legacy/shadow observation 合同；只用于隔离控制面 parity |
