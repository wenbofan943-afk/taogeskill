...
| [schema/workflow-kernel/](./schema/workflow-kernel/) | M2 direct request、M3 hotspot command / observation，以及 M4 session runtime binding / entry decision 合同；M4 binding 是真实 session 的不可变代际标记，但不等于 runtime certification |
