...
| [schema/r8/h5/](./schema/r8/h5/) | R8-H5 v0.2 九类独立评估对象、兼容矩阵与 supersedes Schema；`inputs/` 含 H5R2 六个版本化双臂直接输入 Schema，`requests/` 与 `business/` 含 H5R3 recorder 请求及 router 业务产物 Schema |
