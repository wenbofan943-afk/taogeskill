...
| [schema/workflow-kernel/](./schema/workflow-kernel/) | M2 direct request、M3 hotspot start/resume command、external activity、stage result envelope 与 normalized observation 合同；只用于隔离控制面 parity / branch conformance |
