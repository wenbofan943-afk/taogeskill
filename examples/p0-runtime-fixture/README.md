...
合同边界：本目录固定为 `p0-runtime-v0.1 / html_fragments_v0.1` legacy fixture，用于旧 runtime 回归和只读兼容验证；P0-H1 v0.2 正反合同位于 `examples/p0-h1-contract-fixtures/`。不得把本目录的成功渲染说成 `typed_components_v0.2` renderer 已生效。
