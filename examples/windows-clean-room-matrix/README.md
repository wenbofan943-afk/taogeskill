...
R4-WIN-H5 的 12 个 canonical case：
...
完整矩阵不读取真实账号、不联网、不安装模块、不修改注册表、Group Policy、全局 execution policy 或用户全局 Git。网络盘、OneDrive、大小写敏感 NTFS、企业 Group Policy、ARM64、Windows Server 和非 NTFS 仍为 `not_certified`。
