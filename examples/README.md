...
| 想看业务 Skill 的入口体量、职责与 references 是否发生漂移 | `r8-skill-context-fixtures` | H1 对 26 个项目业务 Skill 做机器清单与 11 个 mutation 校验；H2 另用 10 个场景验证热点 current 条件加载、legacy 隔离和 metadata，不联网、不调用 provider |
