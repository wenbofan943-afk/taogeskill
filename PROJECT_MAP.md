...
| `routes/r8-h5-evaluation-contracts.yaml`、`routes/r8-h5-arm-adapters.yaml` | R8-H5 v0.2 九类独立评估对象、门禁顺序、producer / consumer、路径与兼容状态，以及 H5R2 六个版本化双臂 adapter 真源 |
...
| `templates/schema/r8/h5/` | R8-H5 v0.2 九类评估对象与 v0.1/v0.2 兼容 Schema；`inputs/` 为 H5R2 六个 baseline/candidate typed input Schema |
