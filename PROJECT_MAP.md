...
| `routes/r8-h5-evaluation-contracts.yaml`、`routes/r8-h5-arm-adapters.yaml`、`routes/r8-h5-machine-evaluation.yaml` | R8-H5 v0.2 九类评估对象、H5R2 六个版本化 adapter，以及 H5R3 业务输出 Schema / 共享语义 / false-success 机器真源 |
...
| `templates/schema/r8/h5/` | R8-H5 v0.2 九类评估对象与兼容 Schema；`inputs/` 为 H5R2 双臂输入，`requests/` 与 `business/` 为 H5R3 recorder 请求和 router 最小可比输出合同 |
