...
| `docs/governance/agent-orchestration/workflow-kernel-simplification.md` | `ARCH-20260718-002` 工作流复杂度根因、七阶段轻量内核、M1 静态编译、M2 direct shadow、M3 hotspot shadow 结果与 M4-M6 边界 |
