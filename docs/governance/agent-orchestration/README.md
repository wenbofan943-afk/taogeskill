...
| `workflow-kernel-simplification.md` | `ARCH-20260718-002` 工作流复杂度根因、七阶段轻量内核、三份机器真源、M1 静态编译结果和 shadow 迁移 |
...
| `../../../routes/current-workflow-ir.json` | M1 两条 current route 与 7 个顶层阶段机器真源；当前不切换 runtime |
| `../../../routes/component-catalog.json` | M1 35 个 current stage-internal component 的实现与合同真源 |
