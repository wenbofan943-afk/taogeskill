...
| `workflow-kernel-simplification.md` | `ARCH-20260718-002` 工作流复杂度根因、七阶段轻量内核、三份机器真源、M1-M5.1 迁移结果与 M6 direct 认证面 |
| `m6-independent-certification.md` | M6 五类摘要冻结、evaluator/runtime conformance、direct 控制面认证与 hotspot 后续顺序 |
...
| `../../../routes/m6-certification-contract.json` | M6 五类冻结文件、evaluator/runtime suite、direct certification surface 与 hotspot 状态机器合同 |
