...
retention_task: 让车商一眼看到“问题堆积”的压力
insert_after_text: 你发现没有，很多车商现在最累的地方，不是车不好卖，而是解释不完。
insert_before_text: 客户一上来就问：这车有没有事故？
aspect_ratio: 16:9
prompt_card:
  scene: 二手车展厅办公桌上，屏幕和便签堆满客户问题
  subject: 一位车商坐在桌前，看着密密麻麻的问题列表
