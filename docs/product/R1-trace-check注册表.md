...
## 7. 对 S20260706-005 的返修校准

S20260706-005 是 R1 第一轮编译后的新样本。它不应被删除，也不应被当成完整真实测试通过；它的价值是暴露 R1 返修项。
...
R1CHK-109 warn，S20260706-005 只能证明 R1 单篇主链路，不代表完整真实测试通过
...
## 8. 对 S20260706-002 的校准

如果用本注册表校准 `S20260706-002`，初步预期：
